...
class MainActivityRespaldoCompleto : Activity() {
    ...
    private fun initInterpreter() {
        try {
            ...
            val options = Interpreter.Options().apply {
                setNumThreads(2) // No uses más de 2 si es un celular de gama media
                // Comenta la siguiente línea si hay problemas con NNAPI
                //setUseNNAPI(true)
            }
            ...
            resultTextView.text = "Error cargando modelo: ${e.message}"
        }
    }
